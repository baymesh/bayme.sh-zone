...
D("bayme.sh", REG_NONE, DnsProvider(DNS_PB),
    ...
    CNAME("www", "@"),
    CNAME("flasher", "baymesh.github.io."),
    CNAME("firmware", "baymesh.github.io."),
    CNAME("_dmarc", "dmarc.protection.outlook.com."),
    CNAME("meshyview", "meshyview.pages.dev."),
